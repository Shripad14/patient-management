...
public final class BillingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<billing.BillingRequest,
      billing.BillingResponse> getCreateBillingServiceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateBillingService",
  ...
  public static io.grpc.MethodDescriptor<billing.BillingRequest,
      billing.BillingResponse> getCreateBillingServiceMethod() {
    io.grpc.MethodDescriptor<billing.BillingRequest, billing.BillingResponse> getCreateBillingServiceMethod;
    if ((getCreateBillingServiceMethod = BillingServiceGrpc.getCreateBillingServiceMethod) == null) {
      synchronized (BillingServiceGrpc.class) {
        if ((getCreateBillingServiceMethod = BillingServiceGrpc.getCreateBillingServiceMethod) == null) {
          BillingServiceGrpc.getCreateBillingServiceMethod = getCreateBillingServiceMethod =
              io.grpc.MethodDescriptor.<billing.BillingRequest, billing.BillingResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateBillingService"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  billing.BillingRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  billing.BillingResponse.getDefaultInstance()))
              .setSchemaDescriptor(new BillingServiceMethodDescriptorSupplier("CreateBillingService"))
              .build();
        }
      }
    }
    return getCreateBillingServiceMethod;
  }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void createBillingService(billing.BillingRequest request,
        io.grpc.stub.StreamObserver<billing.BillingResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getCreateBillingServiceMethod(), responseObserver);
    }
  }
  ...
  public static final class BillingServiceStub
    ...
    /**
     */
    public void createBillingService(billing.BillingRequest request,
        io.grpc.stub.StreamObserver<billing.BillingResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getCreateBillingServiceMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class BillingServiceBlockingV2Stub
    ...
    /**
     */
    public billing.BillingResponse createBillingService(billing.BillingRequest request) throws io.grpc.StatusException {
      return io.grpc.stub.ClientCalls.blockingV2UnaryCall(
          getChannel(), getCreateBillingServiceMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class BillingServiceBlockingStub
    ...
    /**
     */
    public billing.BillingResponse createBillingService(billing.BillingRequest request) {
  ...
  public static final class BillingServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<billing.BillingResponse> createBillingService(
        billing.BillingRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getCreateBillingServiceMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_CREATE_BILLING_SERVICE = 0;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_BILLING_SERVICE:
          serviceImpl.createBillingService((billing.BillingRequest) request,
              (io.grpc.stub.StreamObserver<billing.BillingResponse>) responseObserver);
          break;
        default:
  ...
  public static final io.grpc.ServerServiceDefinition bindService(AsyncService service) {
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          getCreateBillingServiceMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              billing.BillingRequest,
              billing.BillingResponse>(
                service, METHODID_CREATE_BILLING_SERVICE)))
        .build();
  }
      ...
      synchronized (BillingServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getCreateBillingServiceMethod())
              .build();
        }
      }
    }
